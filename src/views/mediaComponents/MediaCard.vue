<template>
  ...
  >
    <article
      class="flex h-full w-full flex-col justify-between overflow-hidden rounded-2xl bg-white shadow-[0px_-1.2px_20.23px_0px_rgba(0,0,0,0.25)] transition duration-300 hover:-translate-y-2 hover:shadow-[0_12px_35px_rgb(0,0,0,0.16)] motion-reduce:transition-none motion-reduce:hover:translate-y-0"
      itemscope
    ...
    >
      <div class="relative h-42.5 w-full overflow-hidden bg-slate-100">
        ...
        <span
          class="absolute right-3 top-3 rounded-md bg-[#3E5A78] px-6 py-2 text-xs font-bold uppercase text-white sm:px-8"
      ...
      <div class="flex grow flex-col justify-between px-4 py-5">
        <div>
          <h3
            class="line-clamp-2 text-base font-semibold text-black transition group-hover:text-primary sm:text-lg"
            itemprop="headline"
          >
            {{ card.title }}
          </h3>
          ...
          <p
            class="mt-1 line-clamp-2 text-sm leading-4 text-[#5F5F5F]"
