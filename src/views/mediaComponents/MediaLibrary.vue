<template>
  ...
  <section
    class="w-full bg-white py-10 sm:py-15"
  ...
  >
    <div class="mx-auto px-5 xs:px-6 sm:px-8 lg:px-20 wide:px-20">
      ...
      <div class="mb-10 flex justify-center sm:mb-20" role="search">
        ...
        <div
          class="flex h-12 w-full max-w-190 items-center rounded-xl border-2 border-primary bg-[#7988D221] px-5 shadow-sm"
        >
          ...
          <input
            ...
            placeholder="Search..."
            autocomplete="off"
            aria-label="Search media by title, company, or industry"
      ...
      <!-- Filters Wrapper -->
      <div
        class="-mx-5 flex gap-3 overflow-x-auto px-5 pb-10 sm:-mx-8 sm:px-8 sm:pb-20 xs:-mx-6 xs:px-6 md:grid md:grid-cols-5 md:gap-4 lg:mx-0 lg:px-0 no-scrollbar"
      ...
      <div
        id="media-card-list"
        class="mt-8 grid grid-cols-[repeat(auto-fill,minmax(min(100%,400px),1fr))] justify-center gap-x-6 gap-y-10"
      ...
      <p
        ...
        role="status"
        aria-live="polite"
        class="mb-10 text-center text-sm text-primary"
      >
