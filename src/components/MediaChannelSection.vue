        ...
        <div class="relative z-10 mx-auto max-w-[1600px] px-5 xs:px-6 sm:px-8 lg:px-25">
            ...
            <div class="grid grid-cols-12 gap-2.5">
                ...
                <div class="col-span-12 grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-4">
                    ...
                    <!-- VIDEO CARDS -->
                    <article v-for="video in videos" :key="video.title"
                    ...
                    <aside
                        ...
                        <h3 id="media-channel-title" class="text-3xl font-medium uppercase">
                            Media Channel
                        </h3>
                        ...
                        <router-link to="/media" aria-label="Browse more videos from the media channel"
                            class="mt-8 flex w-full items-center justify-center gap-2 rounded-4xl bg-white px-6 py-3 text-lg font-bold text-[#11213A] transition-all duration-300 hover:bg-[#EEF0FF] focus:outline-none focus-visible:ring-4 focus-visible:ring-white/80">
                            Browse More
