                    ...
                    <div class="col-span-12 lg:col-span-5">
                        ...
                        <div class="flex flex-col items-center text-center text-[#111111] lg:items-start lg:text-left">
                            ...
                            <div class="flex justify-center lg:justify-start">
                                ...
                                <button type="button" :aria-expanded="showForm" @click="showForm = true" class="mt-4 rounded-md bg-[#112E56] px-8 py-3 text-xs font-bold uppercase tracking-wider text-white transition duration-300 hover:bg-[#1B355B] cursor-pointerfocus:outline-2 focus:outline-offset-2 focus:outline-[#112E56] sm:mt-6">
                                        Become a member
                                </button>
                            </div>
                        </div>
